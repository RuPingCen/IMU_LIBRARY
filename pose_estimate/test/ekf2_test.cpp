    ...
    { 
		...
		else
		{
			if((imu.IMUFlag&0x01) && (imu.IMUFlag&0x02))
			{
				...
				//ekf2_ahrs.Run(dt,gyro,acc);			
			}
		}

		Eigen::Vector4d dq_imu = ekf2_ahrs.getQuaternion();
